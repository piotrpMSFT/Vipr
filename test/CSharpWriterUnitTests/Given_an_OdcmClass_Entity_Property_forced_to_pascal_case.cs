...
namespace CSharpWriterUnitTests
{
    public class Given_an_OdcmClass_Entity_Property_forced_to_pascal_case : EntityTestBase
    {
        ...
        [Fact]
        public void When_the_renamed_property_is_set_it_triggers_OnPropertyChanged_with_the_original_name()
        {

            //fetcher collection properties
            //concrete ifetcher collection properties
            //concrete collection accesor properties
        }
    }
}
